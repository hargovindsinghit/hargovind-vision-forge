    ...
    >
        ...
        <div className="container mx-auto px-6 py-4 relative">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link to="/" className={`${isDark ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>Home</Link>
              <Link to="/about" className={`${isDark ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>About</Link>
              <Link to="/services" className={`${isDark ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>Services</Link>
              <Link to="/case-studies" className={`${isDark ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>Case Studies</Link>
              <Link to="/contact" className={`${isDark ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>Contact</Link>
      ...
      <section className="pt-32 pb-20 px-6 relative">
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-6xl mx-auto">
            <h1 className={`text-6xl md:text-8xl lg:text-9xl font-display font-bold mb-8 ${isDark ? 'text-white' : 'text-gray-900'} leading-[0.9] tracking-tight text-balance`}>
              Building Tomorrow's
            ...
            <p className={`text-lg md:text-xl lg:text-2xl mb-12 ${isDark ? 'text-gray-200' : 'text-gray-700'} max-w-4xl mx-auto leading-relaxed font-light tracking-wide text-pretty`}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-10 py-4 text-lg font-medium tracking-wide shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 hover:scale-105">
                See Our Solutions <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
              <Button variant="outline" className={`px-10 py-4 text-lg font-medium tracking-wide ${isDark ? 'border-cyan-400/50 text-cyan-400 hover:bg-cyan-400/10 backdrop-blur-sm' : 'border-blue-400 text-blue-600 hover:bg-blue-50'} transition-all duration-300 hover:scale-105`}>
                Get a Demo
              </Button>
            </div>
          </div>
      ...
      <section className="py-20 px-6 relative">
        <div className="container mx-auto relative z-10">
          <h2 className={`text-4xl md:text-5xl lg:text-6xl font-display font-bold text-center mb-16 ${isDark ? 'text-white' : 'text-gray-900'} tracking-tight text-balance`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className={`group p-8 rounded-2xl ${isDark ? 'bg-gray-800/40 hover:bg-gray-800/60 border border-cyan-500/20' : 'bg-white/40 hover:bg-white/60 border border-blue-200'} backdrop-blur-md transition-all duration-500 hover:scale-105 cursor-pointer hover:shadow-2xl ${isDark ? 'hover:shadow-cyan-500/20' : 'hover:shadow-blue-500/20'}`}>
                ...
                <h3 className={`text-xl md:text-2xl font-display font-bold mb-4 ${isDark ? 'text-white' : 'text-gray-900'} tracking-tight`}>{domain.title}</h3>
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'} text-base md:text-lg leading-relaxed mb-6 font-light`}>{domain.desc}</p>
                <div className="mt-auto">
                  <span className={`text-transparent bg-clip-text bg-gradient-to-r ${domain.gradient} hover:from-cyan-300 hover:to-blue-400 cursor-pointer font-medium text-sm md:text-base tracking-wide group-hover:translate-x-2 transition-transform duration-300 inline-block`}>
                    Learn More →
                  </span>
                </div>
              </div>
      ...
      <section className={`py-20 px-6 relative ${isDark ? 'bg-gray-800/30' : 'bg-white/30'} backdrop-blur-md`}>
        <div className="container mx-auto text-center relative z-10">
          <h2 className={`text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-8 ${isDark ? 'text-white' : 'text-gray-900'} tracking-tight text-balance`}>
          ...
          <Link to="/contact">
            <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-12 py-4 text-xl font-medium tracking-wide shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 hover:scale-105">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/about" className={`${isDark ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>About Us</Link></li>
                <li><Link to="/services" className={`${isDark ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>Services</Link></li>
                <li><Link to="/case-studies" className={`${isDark ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>Case Studies</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className={`${isDark ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>LinkedIn</a>
                <a href="#" className={`${isDark ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-blue-600'} transition-colors font-medium text-sm tracking-wide`}>Twitter</a>
              </div>
            </div>
          </div>
